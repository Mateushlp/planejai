import { ChatBox } from '@/components/features/FinancialChat/ChatBox';
...
export function SimulationResultsPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
      <PageHero
        title="Resultado da sua simulaçao"
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <Card
          ...
          value={`R$ ${monthlySavings.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} meses`}
          subtitle={'Economia Mensal Necessaria'}
        />
      </div>
      <div className="grid gap-6 lg:grid-cols-3">
        <AIInsightsCard simulationId={data.id} />
        <ChatBox simulation={data} />
